...
export const en: Dict = {
  ...
  param: {
    ...
    opt: {
      ...
      free: 'Free',
      rotate90: 'Rotate 90°', rotate180: 'Rotate 180°', rotate270: 'Rotate 270°',
      flipH: 'Flip horizontal', flipV: 'Flip vertical',
      grayscale: 'B&W', invert: 'Invert', blur: 'Blur', sharpen: 'Sharpen',
      sepia: 'Sepia', contrast: 'Contrast', brightness: 'Brightness',
      posTopLeft: 'Top left', posTopRight: 'Top right', posCenter: 'Center',
      posBottomLeft: 'Bottom left', posBottomRight: 'Bottom right',
      posBottomCenter: 'Bottom center', posTopCenter: 'Top center',
      code128: 'CODE-128', ean13: 'EAN-13',
      fmtFormat: 'Format', minify: 'Minify',
      now: 'Now', toDate: 'Epoch → date', toEpoch: 'Date → epoch',
      v4: 'v4', v7: 'v7',
      htmlEscape: 'Escape HTML', htmlUnescape: 'Unescape HTML',
      urlEncode: 'Encode URL', urlDecode: 'Decode URL', queryEscape: 'Escape path',
    ...
    pdf: {
      ...
      attachfiles: { label: 'File to attach', hint: 'Select the file to embed in the PDF' },
      doctitle: { label: 'Title', placeholder: 'E.g. Monthly report' },
      docbody: { label: 'Text', placeholder: 'Write the paragraphs here…' },
