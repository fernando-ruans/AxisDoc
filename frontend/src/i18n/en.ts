...
export const en: Dict = {
  ...
  param: {
    ...
    img: {
      ...
      preset: { label: 'Size', hint: 'Custom opens the width field' },
      ...
      y: { label: 'Start Y' },
      anchor: { label: 'Anchor' },
      ratio: { label: 'Ratio', hint: 'Locks height from width' },
      coords: { hint: 'Use the preview; numbers are fine-tuning' },
      transform: { label: 'Operation' },
      filter: { label: 'Filter' },
      strength: { label: 'Strength', hint: 'Blur, sharpen, contrast and brightness' },
      wmimage: { label: 'Watermark image' },
      wmkind: { label: 'Watermark type' },
