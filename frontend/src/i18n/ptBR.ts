export const ptBR = {
  ...
  param: {
    ...
    opt: {
      ...
      text: 'Texto', image: 'Imagem',
      free: 'Livre',
      rotate90: 'Girar 90°', rotate180: 'Girar 180°', rotate270: 'Girar 270°',
      flipH: 'Espelhar horizontal', flipV: 'Espelhar vertical',
      grayscale: 'P&B', invert: 'Inverter', blur: 'Desfoque', sharpen: 'Nitidez',
      sepia: 'Sépia', contrast: 'Contraste', brightness: 'Brilho',
      posTopLeft: 'Superior esquerda', posTopRight: 'Superior direita', posCenter: 'Centro',
      posBottomLeft: 'Inferior esquerda', posBottomRight: 'Inferior direita',
      posBottomCenter: 'Inferior centro', posTopCenter: 'Superior centro',
      code128: 'CODE-128', ean13: 'EAN-13',
      fmtFormat: 'Formatar', minify: 'Minificar',
      now: 'Agora', toDate: 'Epoch → data', toEpoch: 'Data → epoch',
      v4: 'v4', v7: 'v7',
    ...
    pdf: {
      ...
      attachfiles: { label: 'Arquivo para anexar', hint: 'Selecione o arquivo a embutir no PDF' },
      doctitle: { label: 'Título', placeholder: 'Ex.: Relatório mensal' },
      docbody: { label: 'Texto', placeholder: 'Escreva os parágrafos aqui…' },
