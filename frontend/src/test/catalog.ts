...
export const CANONICAL_CATALOG: ToolInfo[] = [
  ...
  },
  {
    ...
    params: [
      param('preset', 'param.img.preset.label', 'select', { options: ['custom', '320', '800', '1920', 'original'], default: '800', widget: 'segmented', hint: 'param.img.preset.hint' }),
      param('width', 'param.img.maxwidth.label', 'number', { default: 800, min: 1, max: 20000, visibleIf: { key: 'preset', equals: 'custom' } }),
    ],
  },
  {
    ...
    params: [
      param('kind', 'param.img.wmkind.label', 'select', { options: ['text', 'image'], default: 'text', widget: 'segmented' }),
      param('text', 'param.pdf.text.label', 'text', { required: true, default: '© AxisDoc', visibleIf: { key: 'kind', equals: 'text' } }),
      param('opacity', 'param.img.opacity.label', 'number', { default: 0.3, min: 0.05, max: 1, widget: 'slider', visibleIf: { key: 'kind', equals: 'text' } }),
      param('image', 'param.img.wmimage.label', 'file', { accept: ['.png', '.jpg', '.jpeg'], visibleIf: { key: 'kind', equals: 'image' } }),
      param('position', 'param.img.position.label', 'select', { options: ['topLeft', 'topRight', 'center', 'bottomLeft', 'bottomRight'], default: 'bottomRight', widget: 'segmented', visibleIf: { key: 'kind', equals: 'image' } }),
      param('scale', 'param.img.wmscale.label', 'number', { default: 20, min: 5, max: 90, widget: 'slider', visibleIf: { key: 'kind', equals: 'image' } }),
    ],
  },
  {
    ...
    params: [
      param('ratio', 'param.img.ratio.label', 'select', { options: ['free', '1:1', '4:3', '16:9'], default: 'free', widget: 'segmented', hint: 'param.img.ratio.hint' }),
      param('x', 'param.img.x.label', 'number', { default: 0, min: 0, hint: 'param.img.coords.hint' }),
      param('y', 'param.img.y.label', 'number', { default: 0, min: 0 }),
      param('w', 'param.img.width.label', 'number', { default: 100, min: 1 }),
      param('h', 'param.img.height.label', 'number', { default: 100, min: 1 }),
    ],
  },
  {
    ...
    params: [
      param('op', 'param.img.transform.label', 'select', { options: ['rotate90', 'rotate180', 'rotate270', 'flipH', 'flipV'], default: 'rotate90', widget: 'cards' }),
    ],
  },
  {
    ...
    params: [
      param('filter', 'param.img.filter.label', 'select', { options: ['grayscale', 'invert', 'blur', 'sharpen', 'sepia', 'contrast', 'brightness'], default: 'grayscale', widget: 'cards' }),
      param('strength', 'param.img.strength.label', 'number', { default: 5, min: 0, max: 10, widget: 'slider', hint: 'param.img.strength.hint' }),
    ],
  },
  {
  ...
  },
  {
    ...
    params: [
      param('delay', 'param.gif.delay.label', 'number', { default: 100, min: 20, max: 5000, widget: 'slider' }),
  ...
  },
  {
    ...
    params: [
      param('image', 'param.img.wmimage.label', 'file', { required: true, accept: ['.png', '.jpg', '.jpeg'] }),
      param('position', 'param.img.position.label', 'select', { options: ['topLeft', 'topRight', 'center', 'bottomLeft', 'bottomRight'], default: 'bottomRight', widget: 'segmented' }),
      param('scale', 'param.img.wmscale.label', 'number', { default: 20, min: 5, max: 90, widget: 'slider' }),
    ],
  },
  {
